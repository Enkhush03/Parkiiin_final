...
export default function Washing(){
  ...
  <nav className="top-nav" id="topNav" aria-label="Үндсэн навигац">
    ...
    <button className="hamburger" id="hamburgerBtn" onClick={() => window.toggleMenu && window.toggleMenu()} aria-label="Цэс нээх" aria-expanded={false}>
  ...
  <main className="services-content" style={{paddingBottom: '100px'}}>
    ...
    <div className="search-bar" style={{marginBottom: '18px'}} role="search">
      ...
      <input type="text" id="washSearchInput" placeholder="Үйлчилгээний газар хайх..." onInput={(e) => window.filterWash && window.filterWash(e.target.value)}
    ...
    <div className="parking-grid" id="washList" role="list" aria-label="Угаалгын газрууд">
      ...
      <div className="service-card" role="listitem" data-name="cleanmax auto wash" data-distance="1.2" data-rating="4.8"
        ...
        <div className="service-body">
          ...
          <button className="book-btn" onClick={() => { window.location.href = 'wash_repair_booking.html'; }}
